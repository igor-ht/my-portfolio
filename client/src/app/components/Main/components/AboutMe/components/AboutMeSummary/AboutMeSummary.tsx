export default function AboutMeSumarry() {
	return (
		<div className="content-summary-box">
			...
			<br />
			<p>
				I love creating applications from end to end. Designing and developing them is extremely exciting, and coding is definitely the best
				part for me.
				<br />
