		...
		<div id="about-me">
			...
			<div className="resume">
				<p className={`${cormorant_garamond.className}`}>
					A passionate Junior FullStack Developer with main focus in Web Development.
					<br />
					...
					implementing responsive designs, optimizing website performance, integrating APIs and more. This experience has equipped me with a
					solid foundation in web development principles and best practices.
					<br />
